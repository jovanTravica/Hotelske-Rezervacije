<%-- 
    Document   : dodajHotel
    Created on : Aug 1, 2019, 4:34:13 PM
    Author     : jocas
--%>
      ...
      <nav class="navbar navbar-expand-lg  p-3 mb-2 bg-info ">
                ...
                <ul class="navbar-nav  mt-2 " >
                    ...
                    <li class="nav-item">
                        <a href="odjava" class="btn btn-secondary btn-lg ml-4 btn-warning">Odjavi se</a>
                         <li class="nav-item">
                    <a href="podesavanjaProfila.jsp"  class="btn btn-secondary btn-info btn-lg ml-3">Podesavanja profila</a>
                    </li>
                    </li>
                ...
                <div class="col-md-8">
                    ...
                    <form action="dodajHotel" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nazivHotela" type="text" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <label style="font-weight: bold;">Menadzer </label>
                        ...
                        <input type="submit" class="btn btn-primary" value="Dodaj hotel">
